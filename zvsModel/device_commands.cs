        ...
        public virtual ObservableCollection<device_command_options> device_command_options {
    		...
    		set {
    			if (value != _device_command_options){
    			    ObservableCollection<device_command_options> old = _device_command_options;
    				Beforedevice_command_optionsChange(old, value);
    				_device_command_options = value;
    			    NotifyPropertyChanged("device_command_options");
    				Afterdevice_command_optionsChange(old, value);
    			}
    		}
    	 } 
    
    	partial void Beforedevice_command_optionsChange(ObservableCollection<device_command_options> oldValue, ObservableCollection<device_command_options> newValue);
    	partial void Afterdevice_command_optionsChange(ObservableCollection<device_command_options> oldValue, ObservableCollection<device_command_options> newValue);
