...
namespace zVirtualScenesApplication
{
    public partial class formPropertiesMultiLevelSwitch : Form
    {
        ...
        public formPropertiesMultiLevelSwitch(formzVirtualScenes zVirtualScenesMain, ZWaveDevice DeviceToEdit)
        {
            InitializeComponent();
        ...
        private void formPropertiesMultiLevelSwitch_Load(object sender, EventArgs e)
        {
