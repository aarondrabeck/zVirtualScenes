...
namespace OpenZWavePlugin
{
    ...
    public class OpenZWavePlugin : zvsPlugin
    {
        ...
        private void StartOpenzwave()
        {
            ...
            try
            {
                log.DebugFormat("OpenZwave driver starting on {0}", _useHID ? "HID" : "COM" + _comPort);
                                            ...
                                            case "Basic":
                                                ...
                                                if (dv_basic != null)
                                                {
                                                    ...
                                                    if (!prevVal.Equals(data))
                                                    {
                                                        ...
                                                        {
                                                            Debug.WriteLine(string.Format("Timer {0} restarted.", d.DeviceId));
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            t.Elapsed += (sender, e) =>
                                                            {
                                                                ...
                                                                t.Stop();
                                                                Debug.WriteLine(string.Format("Timer {0} Elapsed.", d.NodeNumber));
                                                                timers.Remove(d.NodeNumber);
                                                            };
                                                            t.Start();
                                                            Debug.WriteLine(string.Format("Timer {0} started.", d.NodeNumber));
                                                        }
                                                    }
                                                }
                                                break;
