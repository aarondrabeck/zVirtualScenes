                            ...
                            if (d != null)
                            {
                                ...
                                if (!read_only)
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(label))
                                    {
                                        ...
                                        {
                                            Device = d,
                                            UniqueIdentifier = string.Format("DYNAMIC_CMD_{0}", label.ToUpper()),
                                                    ...
                                                    if (!prevVal.Equals(data))
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            t.Elapsed += (sender, e) =>
                                                            {
                                                                ...
                                                                t.Stop();
                                                                log.Debug(string.Format("Timer {0} Elapsed.", d.NodeNumber));
                                                                timers.Remove(d.NodeNumber);
                                                            };
                                                            t.Start();
                                                            log.Debug(string.Format("Timer {0} started.", d.NodeNumber));
                                                        }
                                                    }
                                                }
                                                break;
