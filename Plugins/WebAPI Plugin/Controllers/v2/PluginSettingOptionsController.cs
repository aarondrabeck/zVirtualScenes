...
{
    [Documentation(typeof(PluginSettingOption), "v2/PluginSettingOptions", 2.1, "All available plug-in setting options.")]
    public class PluginSettingOptionsController : zvsEntityController<PluginSettingOption>
    {
        ...
        public new async Task<IQueryable<PluginSettingOption>> Get()
        {
        ...
        [HttpPost]
        public new async Task<HttpResponseMessage> AddAsync(PluginSettingOption tEntityPost)
        {
