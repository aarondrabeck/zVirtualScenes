...
{
    [Documentation(typeof(BuiltinCommand), "v2/BuiltinCommands", 2.1, "All available built-in commands.")]
    public class BuiltinCommandsController : zvsEntityController<BuiltinCommand>
    {
        ...
        public new async Task<IQueryable<BuiltinCommand>> Get()
        {
        ...
        [HttpPost]
        public new async Task<HttpResponseMessage> AddAsync(BuiltinCommand tEntityPost)
        {
