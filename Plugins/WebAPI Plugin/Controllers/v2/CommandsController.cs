...
{
    [Documentation(typeof(CommandOption),"v2/CommandOptions", 2.1, "All available command options.")]
    public class CommandOptionsController : zvsEntityController<CommandOption>
    {
        ...
        public new async Task<IQueryable<CommandOption>> Get()
        {
        ...
        [HttpPost]
        public new async Task<HttpResponseMessage> AddAsync(CommandOption tEntityPost)
        {
