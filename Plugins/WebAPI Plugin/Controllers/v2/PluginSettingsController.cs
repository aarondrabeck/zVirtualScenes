...
{
    [Documentation(typeof(PluginSetting), "v2/PluginSettings", 2.1, "All available plug-in settings.")]
    public class PluginSettingsController : zvsEntityController<PluginSetting>
    {
        ...
        public new async Task<IQueryable<PluginSetting>> Get()
        {
        ...
        [HttpPost]
        public new async Task<HttpResponseMessage> AddAsync(PluginSetting tEntityPost)
        {
