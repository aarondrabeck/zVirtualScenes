...
{
    [Documentation(typeof(ProgramOption), "v2/ProgramOptions", 2.1, "All set program options.")]
    public class ProgramOptionsController : zvsEntityController<ProgramOption>
    {
        ...
        public new async Task<IQueryable<ProgramOption>> Get()
        {
        ...
        [HttpPost]
        public new async Task<HttpResponseMessage> AddAsync(ProgramOption tEntityPost)
        {
