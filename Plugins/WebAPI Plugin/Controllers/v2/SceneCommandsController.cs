...
{
    [Documentation(typeof(SceneCommand), "v2/SceneCommands", 2.1, "All scene commands.")]
    public class SceneCommandsController : zvsEntityController<SceneCommand>
    {
        ...
        public new async Task<IQueryable<SceneCommand>> Get()
        {
        ...
        [HttpPost]
        public new async Task<HttpResponseMessage> AddAsync(SceneCommand tEntityPost)
        {
