...
{
    [Documentation("v2/QueuedDeviceCommands", 2.1,
    ...
    ")]
    public class QueuedDeviceCommandsController : zvsEntityController<QueuedDeviceCommand>
    {
        public QueuedDeviceCommandsController(WebAPIPlugin webAPIPlugin) : base(webAPIPlugin) { }
        ...
        protected override IQueryable<QueuedDeviceCommand> BaseQueryable
        {
            get
            {
                return base.BaseQueryable.OfType<QueuedDeviceCommand>();
            }
        }
        ...
        [HttpGet]
        [DTOQueryable]
        public new IQueryable<QueuedDeviceCommand> Get()
        {
            return base.Get();
        }
        ...
        [EnableCors]
        [HttpPost]
        public new HttpResponseMessage Add(QueuedDeviceCommand cmd)
        {
            DenyUnauthorized();
            ...
            try
            {
                Task.Run(() => cp.RunDeviceCommandAsync(cmd.CommandId.Value, cmd.Argument));
            }
