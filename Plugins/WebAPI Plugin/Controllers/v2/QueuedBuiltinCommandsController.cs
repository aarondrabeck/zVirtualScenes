...
{
    [Documentation("v2/QueuedBuiltinCommands", 2.1, 
    @"All available queued built-in command.
    ...
    ")]
    public class QueuedBuiltinCommandsController : zvsEntityController<QueuedBuiltinCommand>
    {
        public QueuedBuiltinCommandsController(WebAPIPlugin webAPIPlugin) : base(webAPIPlugin) { }
        ...
        protected override IQueryable<QueuedBuiltinCommand> BaseQueryable
        {
            get
            {
                return base.BaseQueryable.OfType<QueuedBuiltinCommand>();
            }
        }
        ...
        [HttpGet]
        [DTOQueryable]
        public new IQueryable<QueuedBuiltinCommand> Get()
        {
            return base.Get();
        }
        ...
        [EnableCors]
        [HttpPost]
        public new HttpResponseMessage Add(QueuedBuiltinCommand cmd)
        {
            DenyUnauthorized();
            ...
            try
            {
                Task.Run(() => cp.RunBuiltinCommandAsync(cmd.CommandId.Value, cmd.Argument));
            }
