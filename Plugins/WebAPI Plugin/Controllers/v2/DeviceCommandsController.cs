...
{
    [Documentation(typeof(DeviceCommand),"v2/DeviceCommands", 2.1, "All available device commands.")]
    public class DeviceCommandsController : zvsEntityController<DeviceCommand>
    {
        ...
        [HttpPost]
        public new async Task<HttpResponseMessage> AddAsync(DeviceCommand tEntityPost)
        {
