...
{
    [Documentation("v2/DeviceValueTriggers", 2.1, "All available device value triggers.")]
    public class DeviceValueTriggersController : zvsEntityController<DeviceValueTrigger>
    {
        ...
        {
            get { return db.DeviceValueTriggers; }
        }

        [EnableCors]
        [HttpGet]
        [DTOQueryable]
        public new IQueryable<DeviceValueTrigger> Get()
        {
            return base.Get();
        }
        ...
        [EnableCors]
        [HttpPost]
        public new HttpResponseMessage Add(DeviceValueTrigger tEntityPost)
        {
        ...
        [HttpPatch]
        [HttpPut]
        public new HttpResponseMessage Update(int id, Delta<DeviceValueTrigger> device)
        {
