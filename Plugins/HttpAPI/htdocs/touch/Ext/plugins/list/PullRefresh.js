 ...
 */
Ext.define('Ext.plugins.PullRefreshPlugin', {
    ...
    setViewState: function(state) {
        ...
        switch (state) {
            case 'pull':
                ...
                this.el.removeCls([Ext.baseCSSPrefix + 'list-pullrefresh-release', Ext.baseCSSPrefix + 'list-pullrefresh-loading']);
            break;

            case 'release':
                this.messageEl.setHTML(this.releaseRefreshText);
                this.el.addCls(Ext.baseCSSPrefix + 'list-pullrefresh-release');
            break;

            case 'loading':
                this.messageEl.setHTML(this.loadingText);
                this.el.addCls(Ext.baseCSSPrefix + 'list-pullrefresh-loading');
                break;
        }
